            ...
            <div>
                <c:forEach var="houseDeal" items="${houseDeals }">
                    <ul>
                        ...
                        <li>거래년도: ${houseDeal.dealYear }년 ${houseDeal.dealMonth}월 ${houseDeal.dealDay}일</li>
        ...
        <div class="col-md-8">
            <div id="mapDetail" style="width: 100%; height: 500px">
                ...
                <script>
                    ...
                    var lat = "<c:out value='${houseInfo.lat}' />"
                    var lng = "<c:out value='${houseInfo.lng}' />"
