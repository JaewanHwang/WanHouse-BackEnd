...
<div class="container px-4 px-lg-5 mt-3 mb-3">
    <div class="row gx-4 gx-lg-5 justify-content-center">
        <div class="col-md-10 col-lg-8 col-xl-7">
            ...
            <form method="post" action="${root}/board/board_modify">
                <h3>제목</h3>
                <textarea id="title" name="title" class="col-md-12 my-3 p-3" style="border: 1px solid black"
                          required="required">${board.title}</textarea>
                <h3>내용</h3>
                <textarea id="content" name="content" class="col-md-12 my-3 p-3"
                          style="border: 1px solid black; height: 300px" required="required">${board.content}</textarea>
